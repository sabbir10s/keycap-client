        ...
        <div className='px-2 lg:px-10 bg-base-200'>
            <div className="drawer drawer-mobile">
                ...
                <div className="drawer-side">
                    ...
                    <ul className="lg:mx-7 my-5 menu p-4 overflow-y-auto w-60 bg-base-100 rounded-lg text-base-content">
                        ...
                        {admin && <>
                            ...
                            <li><Link to='/dashboard/menageOrders'>Menage Orders</Link></li>
