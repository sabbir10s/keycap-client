        ...
        <div className="md:py-5 lg:py-20 bgImg">
            <div id='#hero' className="container mx-auto px-2 grid grid-cols-1 lg:grid-cols-2 gap-5  items-center">
                <div className='pb-14 order-2 lg:order-1'>
                    <h2 className="text-lg md:text-xl font-medium text-primary-700 ">Largest gadgets supplier</h2>
                    ...
                    <a className="mt-6 border-[1px] border-primary-700 hover:border-[1px] hover:border-transparent bg-white hover:bg-primary-700 text-primary-700 hover:text-white duration-300 w-[150px] py-2 flex items-center justify-center gap-1" href="#products"><span>Shop Now </span> <BsArrowRight className='text-lg' /></a>
                </div>
