...
const ProductCard = ({ product }) => {
    ...
    return (
        <Fade bottom>
            <button className='border border-primary rounded-lg shadow-lg shadow-base-300/60 flex flex-col justify-between duration-150 hover:scale-110 cursor-pointer'>
