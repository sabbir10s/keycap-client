    ...
    return (
        <div>
            ...
            <div className='flex gap-10 pb-5'>
                <CustomLink to='#new' className='text-primary hover:text-secondary' onClick={() => setCategory({ type: "new" })}> <button>New</button> </CustomLink>
                <CustomLink to='#mobile' className='text-primary hover:text-secondary' onClick={() => setCategory({ type: "mobile" })}>Mobile</CustomLink>
                <CustomLink to='#computer' className='text-primary hover:text-secondary' onClick={() => setCategory({ type: "computer" })}>Computer</CustomLink>
                <CustomLink to='#smart' className='text-primary hover:text-secondary' onClick={() => setCategory({ type: "smart" })}>Smart</CustomLink>
            </div>
