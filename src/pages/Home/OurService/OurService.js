    ...
    return (
        <div className='bg-primary-700 py-20'>
            <div className='max-w-[1400px] mx-auto lg:px-20 px-2 '>
                <h2 className='text-gray-100 text-center text-2xl font-bold uppercase pb-10'>what we provide</h2>
                <div className='flex flex-col md:flex-row justify-center items-center gap-5'>
                    <div className='border w-[300px] h-[200px] p-5 bg-gray-100 rounded-lg flex justify-center items-center'>
                        <div className='text-center'>
                            ...
                            <h3 className='text-xl text-primary-700 font-bold'>Best Quality</h3>
                    ...
                    <div className='border w-[300px] h-[200px] p-5 bg-gray-100 rounded-lg flex justify-center items-center'>
                        <div className='text-center'>
                            ...
                            <h3 className='text-xl text-primary-700 font-bold'>Large quantity</h3>
                    ...
                    <div className='border w-[300px] h-[200px] p-5 bg-gray-100 rounded-lg flex justify-center items-center'>
                        <div className='text-center'>
                            ...
                            <h3 className='text-xl text-primary-700 font-bold'>After Sell Service</h3>
